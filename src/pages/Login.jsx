...
import LogoTemuNoBg from "../assets/temuCS long dark.png"; // sesuaikan path jika beda
    ...
    <div className="bg-[#F6F5F2] h-screen flex flex-col justify-center items-center">
      <div className="cont w-80">
        <div className="flex justify-center mb-5">
          <img src={LogoTemuNoBg} alt="logo" className="h-30 object-contain" />
        </div>

        <form className="flex flex-col gap-5" onSubmit={handleLogin}>
          <h1 className="text-center font-bold text-xl">Login TV Branch</h1>
